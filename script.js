...
const translations = {
    en: {
        mainTitle: "Art or AI? – The EU-AI-Quiz",
        ...
        restart: "Start Over",
        expert: "Over 90% correct – You are an AI expert!",
        advanced: "Great job! You have a sharp eye for digital details.",
        study: "Under 70% – You should be more careful with digital elements and study AI work more closely.",
        modelLabel: "Model",
    ...
    de: {
        mainTitle: "Kunst oder KI? – Das EU-KI-Quiz",
        footerDesc: "Ein Projekt, das europäische Kultur und generative KI-Evaluation verbindet.",
        ...
        chooseMode: "Wähle die Länge des Quiz:",
        exitQuiz: "Quiz beenden",
        finishBtn: "Ergebnis anzeigen 🏁"
    }
};
